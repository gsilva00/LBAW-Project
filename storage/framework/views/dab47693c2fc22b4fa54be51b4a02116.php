    ...
    <div id="footer-page-content">
        <div id="footer-page-phone">
            ...
            <button type="button" class="large-rectangle" onclick="
                    <?php if(Auth::check()): ?>
                        window.location='<?php echo e(route('createArticle')); ?>'
                    <?php else: ?>
        ...
        <div id="footer-page-mail">
            ...
            <br>
            <button type="button" class="large-rectangle" onclick="window.location='<?php echo e(route('showRecentNews')); ?>'">
        ...
        <div id="footer-page-pin">
            ...
            <br>
            <button type="button" class="large-rectangle" onclick="window.location='<?php echo e(route('homepage')); ?>'">
        ...
        <div id="footer-page-">
            ...
            <br>
            <button type="button" class="large-rectangle" onclick="window.location='<?php echo e(route('showMostVotedNews')); ?>'">
        ...
        <div id="footer-page-">
            ...
            <button type="button" class="large-rectangle" onclick="
                    <?php if(Auth::check()): ?>
                        window.location='<?php echo e(route('profile', ['username' => $user->username])); ?>'
                    <?php else: ?>
                        window.location='<?php echo e(route('login')); ?>'
                    <?php endif; ?>
                    ">
        ...
        <div id="footer-page-">
            ...
            <button type="button" class="large-rectangle" onclick="
                    <?php if(Auth::check()): ?>
                        window.location='<?php echo e(route('userFeed')); ?>'
                    <?php else: ?>
                        window.location='<?php echo e(route('login')); ?>'
                    <?php endif; ?>
                    ">
        ...
        <div id="footer-page-">
            ...
            <button type="button" class="large-rectangle" onclick="
                    <?php if(Auth::check()): ?>
                        window.location='<?php echo e(route('showFavouriteArticles')); ?>'
                    <?php else: ?>
                        window.location='<?php echo e(route('login')); ?>'
                    <?php endif; ?>
                    ">
        ...
        <div id="footer-page-">
            ...
            <button type="button" class="large-rectangle" onclick="
                    <?php if(Auth::check()): ?>
                        window.location='<?php echo e(route('notifications.show.page')); ?>'
                    <?php else: ?>
                        window.location='<?php echo e(route('login')); ?>'
                    <?php endif; ?>
                    ">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Utiizador\Desktop\LBAW\lbaw24124\resources\views/pages/features.blade.php ENDPATH**/ ?>
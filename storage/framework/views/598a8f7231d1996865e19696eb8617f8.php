<header>
    ...
    <div id="bottom-part-header">
        ...
        <h2 class="topic">
            <a href="<?php echo e(route('showTopic', ['name' => 'Business'])); ?>">Business</a>
        </h2>
        <h2 class="topic">
            <a href="<?php echo e(route('showTopic', ['name' => 'Technology'])); ?>">Technology</a>
        </h2>
        <h2 class="topic">
            <a href="<?php echo e(route('showTopic', ['name' => 'Science'])); ?>">Science</a>
        </h2>
        ...
        <div class="dropdown-menu" aria-labelledby="all-topics-button">
            <?php $__currentLoopData = $topics; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $topic): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <a class="dropdown-item" href="<?php echo e(route('showTopic', ['name' => $topic->name])); ?>"><h2><?php echo e($topic->name); ?></h2></a>

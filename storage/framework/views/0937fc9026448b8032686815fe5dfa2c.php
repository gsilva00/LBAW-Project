...
<?php $__env->startSection('content'); ?>
    <div class="profile-wrapper">
        ...
        <form method="POST" action="<?php echo e(route('profile.update')); ?>" enctype="multipart/form-data">
            ...
            <input type="text" name="username" id="username" value="<?php echo e(old('username', $username)); ?>" autocomplete="off">
            ...
            <input type="email" name="email" id="email" value="<?php echo e(old('email', $email)); ?>" autocomplete="email">
            ...
            <input type="text" name="display_name" id="display_name" value="<?php echo e(old('display_name', $displayName)); ?>" autocomplete="name">
            </div>
            <br>
            <div class="profile-info">
            <label for="description"><span>Description</span></label>
            <input type="text" name="description" id="description" value="<?php echo e(old('description', $description)); ?>">
            </div>
            <br>
            <div class="profile-info">
            ...
            <button class="large-rectangle small-text greyer"> Delete This Account </button>  <!-- Need to do action here -->
            </div>
        </form>
        </section>
    </div>

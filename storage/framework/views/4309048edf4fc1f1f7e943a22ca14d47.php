<div class="comment">
    ...
    <span><?php echo e($article->is_deleted ? '[Deleted]' : $comment->content); ?>

    </span>
    <div class="comment-actions">
    <div class="large-rectangle fit-block comment-votes"><button><i class='bx bx-upvote' title="upvote comment"></i></button><span><?php echo e($comment->upvotes - $comment->downvotes); ?></span><button title="upvote comment"><i class='bx bx-downvote' ></i></button></div>

<form id="comment-form" class="comment" method="POST" action="<?php echo e(route('writeComment', ['id' => $article->id])); ?>">
    ...
    <?php if(Auth::guest() || $user->is_deleted): ?>
        <img src="<?php echo e(asset('images/profile/default.jpg')); ?>" alt="Your profile picture">
    <?php else: ?>
        <img src="<?php echo e(asset('images/profile/' . $user->profile_picture)); ?>" alt="Your profile picture">
    <?php endif; ?>

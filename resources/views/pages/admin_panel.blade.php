...
@section('content')
    <div class="content">
        <h2>Users:</h2>
        <form id="createFullUserForm" method="POST" action="{{ route('adminPanel.createUser') }}" enctype="multipart/form-data">
            @csrf
        ...
        <br>
        <div id="users-section" style="height: 800px; overflow-y: scroll;">
            <ul id="user-list">
